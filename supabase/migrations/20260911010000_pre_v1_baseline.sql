...
-- \restrict Pa7tBGdgkBWFHOehVoymg8EeXFCh97XDFzo8fsv1HKLPCyYEJQHnKUHhmkRw0nQ
...
--
-- Name: loyalty_reward_status; Type: TYPE; Schema: public; Owner: postgres
--
...
--
-- Name: pickup_availability_mode; Type: TYPE; Schema: public; Owner: postgres
--
...
--
-- Name: assign_daily_order_number(); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE OR REPLACE FUNCTION "public"."assign_daily_order_number"() RETURNS "trigger"
...
ALTER FUNCTION "public"."assign_daily_order_number"() OWNER TO "postgres";

--
-- Name: attach_paymongo_checkout("uuid", "text", "text"); Type: FUNCTION; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION "attach_paymongo_checkout"("target_payment_id" "uuid", "checkout_id" "text", "checkout_url" "text"); Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: cancel_account_deletion(); Type: FUNCTION; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION "cancel_account_deletion"(); Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: cancel_unpaid_order("uuid", "uuid", "text"); Type: FUNCTION; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION "cancel_unpaid_order"("target_order_id" "uuid", "target_user_id" "uuid", "expired_checkout_id" "text"); Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: consume_mutation_rate_limit("text"[], integer, integer); Type: FUNCTION; Schema: public; Owner: postgres
--
...
--
-- Name: count_admin_customers("uuid", "text"); Type: FUNCTION; Schema: public; Owner: postgres
--
...
--
-- Name: deactivate_due_account("uuid"); Type: FUNCTION; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION "deactivate_due_account"("target_user_id" "uuid"); Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: enforce_admin_limit(); Type: FUNCTION; Schema: public; Owner: postgres
--
...
--
-- Name: enqueue_transactional_order_email(); Type: FUNCTION; Schema: public; Owner: postgres
--
...
--
-- Name: expire_paymongo_order("uuid", "text"); Type: FUNCTION; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION "expire_paymongo_order"("target_payment_id" "uuid", "checkout_id" "text"); Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: expire_pending_orders(); Type: FUNCTION; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION "expire_pending_orders"(); Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: get_admin_customer_summaries("uuid", "text", integer, integer); Type: FUNCTION; Schema: public; Owner: postgres
--
...
--
-- Name: get_admin_dashboard_decisions("uuid", timestamp with time zone, timestamp with time zone, timestamp with time zone, timestamp with time zone); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE OR REPLACE FUNCTION "public"."get_admin_dashboard_decisions"("target_admin_id" "uuid", "period_start" timestamp with time zone, "period_end" timestamp with time zone, "previous_start" timestamp with time zone, "previous_end" timestamp with time zone) RETURNS "jsonb"
    LANGUAGE "plpgsql" STABLE SECURITY DEFINER
    SET "search_path" TO ''
    AS $$
declare
...
ALTER FUNCTION "public"."get_admin_dashboard_decisions"("target_admin_id" "uuid", "period_start" timestamp with time zone, "period_end" timestamp with time zone, "previous_start" timestamp with time zone, "previous_end" timestamp with time zone) OWNER TO "postgres";

--
-- Name: FUNCTION "get_admin_dashboard_decisions"("target_admin_id" "uuid", "period_start" timestamp with time zone, "period_end" timestamp with time zone, "previous_start" timestamp with time zone, "previous_end" timestamp with time zone); Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON FUNCTION "public"."get_admin_dashboard_decisions"("target_admin_id" "uuid", "period_start" timestamp with time zone, "period_end" timestamp with time zone, "previous_start" timestamp with time zone, "previous_end" timestamp with time zone) IS 'Service-role-only Admin dashboard report with business KPIs, mix breakdowns, reviews, and operational decision metrics.';


--
-- Name: get_admin_dashboard_summary("uuid", timestamp with time zone, timestamp with time zone, timestamp with time zone, timestamp with time zone); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE OR REPLACE FUNCTION "public"."get_admin_dashboard_summary"("target_admin_id" "uuid", "period_start" timestamp with time zone, "period_end" timestamp with time zone, "previous_start" timestamp with time zone, "previous_end" timestamp with time zone) RETURNS "jsonb"
    LANGUAGE "plpgsql" STABLE SECURITY DEFINER
    SET "search_path" TO ''
    AS $$
declare
...
ALTER FUNCTION "public"."get_admin_dashboard_summary"("target_admin_id" "uuid", "period_start" timestamp with time zone, "period_end" timestamp with time zone, "previous_start" timestamp with time zone, "previous_end" timestamp with time zone) OWNER TO "postgres";

--
-- Name: FUNCTION "get_admin_dashboard_summary"("target_admin_id" "uuid", "period_start" timestamp with time zone, "period_end" timestamp with time zone, "previous_start" timestamp with time zone, "previous_end" timestamp with time zone); Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON FUNCTION "public"."get_admin_dashboard_summary"("target_admin_id" "uuid", "period_start" timestamp with time zone, "period_end" timestamp with time zone, "previous_start" timestamp with time zone, "previous_end" timestamp with time zone) IS 'Service-role-only full-period Admin KPI, product mix, payment mix, and operational summary.';
...
--
-- Name: FUNCTION "get_public_pickup_inventory"(); Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: get_public_pickup_settings(); Type: FUNCTION; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION "get_public_pickup_settings"(); Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: list_due_paymongo_checkouts(integer); Type: FUNCTION; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION "list_due_paymongo_checkouts"("batch_limit" integer); Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: moderate_order_review("uuid", "uuid", boolean, boolean); Type: FUNCTION; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION "moderate_order_review"("target_admin_id" "uuid", "target_review_id" "uuid", "visible_value" boolean, "featured_value" boolean); Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: prepare_order_cancellation("uuid", "uuid"); Type: FUNCTION; Schema: public; Owner: postgres
--
...
--
-- Name: prepare_paymongo_checkout("uuid", "uuid"); Type: FUNCTION; Schema: public; Owner: postgres
--
...
--
-- Name: process_paymongo_paid_event("text", "uuid", "text", "text", "text", numeric, "jsonb"); Type: FUNCTION; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION "process_paymongo_paid_event"("event_key" "text", "target_order_id" "uuid", "target_order_number" "text", "checkout_id" "text", "payment_id" "text", "paid_amount" numeric, "event_summary" "jsonb"); Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: process_resend_delivery_event("text", "text", "text", timestamp with time zone); Type: FUNCTION; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION "process_resend_delivery_event"("provider_event_id_value" "text", "provider_message_id_value" "text", "event_type_value" "text", "event_created_at_value" timestamp with time zone); Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: promote_admin_by_email("text"); Type: FUNCTION; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION "promote_admin_by_email"("target_email" "text"); Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: prune_mutation_rate_limit_buckets(); Type: FUNCTION; Schema: public; Owner: postgres
--
...
--
-- Name: record_inventory_consumption("uuid", "uuid", integer, "text", "text"); Type: FUNCTION; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION "record_inventory_consumption"("target_admin_id" "uuid", "target_inventory_id" "uuid", "quantity_value" integer, "reason_value" "text", "notes_value" "text"); Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: replace_paymongo_checkout("uuid", "text", "text", "text"); Type: FUNCTION; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION "replace_paymongo_checkout"("target_payment_id" "uuid", "expected_checkout_id" "text", "checkout_id" "text", "checkout_url" "text"); Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: request_account_deletion(); Type: FUNCTION; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION "request_account_deletion"(); Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: review_manual_payment("uuid", "uuid", boolean, "text"); Type: FUNCTION; Schema: public; Owner: postgres
--
...
--
-- Name: set_pickup_date_open("uuid", "uuid", boolean); Type: FUNCTION; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION "set_pickup_date_open"("target_admin_id" "uuid", "target_pickup_date_id" "uuid", "open_value" boolean); Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: submit_manual_payment("uuid", "uuid", "uuid", "text", "text", numeric, timestamp with time zone, "text"); Type: FUNCTION; Schema: public; Owner: postgres
--
...
--
-- Name: sync_completed_order_loyalty(); Type: FUNCTION; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION "sync_completed_order_loyalty"(); Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION "transition_order_status"("target_admin_id" "uuid", "target_order_id" "uuid", "expected_status" "public"."order_status", "next_status" "public"."order_status"); Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: update_catalog_product("uuid", "uuid", "text", numeric, boolean); Type: FUNCTION; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION "update_catalog_product"("target_admin_id" "uuid", "target_product_id" "uuid", "description_value" "text", "price_per_piece_value" numeric, "active_value" boolean); Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: update_pickup_settings("uuid", integer, time without time zone, integer, time without time zone, time without time zone); Type: FUNCTION; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION "update_pickup_settings"("target_admin_id" "uuid", "minimum_lead_days_value" integer, "daily_cutoff_time_value" time without time zone, "grace_minutes_value" integer, "operating_start_value" time without time zone, "operating_end_value" time without time zone); Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: upsert_catalog_addon("uuid", "uuid", "text", numeric, boolean, boolean); Type: FUNCTION; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION "upsert_catalog_addon"("target_admin_id" "uuid", "target_addon_id" "uuid", "name_value" "text", "price_value" numeric, "active_value" boolean, "default_value" boolean); Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: upsert_catalog_coating("uuid", "uuid", "text", "text", "text", numeric, boolean, boolean); Type: FUNCTION; Schema: public; Owner: postgres
--
...
--
-- Name: upsert_daily_inventory("uuid", "date", "uuid", integer, "text"); Type: FUNCTION; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION "upsert_daily_inventory"("target_admin_id" "uuid", "target_pickup_date" "date", "target_product_id" "uuid", "stock_total_value" integer, "notes_value" "text"); Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: upsert_journal_post("uuid", "uuid", "text", "text", "text", "text", "date", "text", "text", "public"."journal_status"); Type: FUNCTION; Schema: public; Owner: postgres
--
...
--
-- Name: upsert_pickup_location("uuid", "uuid", "text", "text", boolean); Type: FUNCTION; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION "upsert_pickup_location"("target_admin_id" "uuid", "target_location_id" "uuid", "name_value" "text", "description_value" "text", "active_value" boolean); Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: upsert_pickup_schedule("uuid", "uuid", "date", "public"."pickup_availability_mode", boolean, "text", "jsonb"); Type: FUNCTION; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION "upsert_pickup_schedule"("target_admin_id" "uuid", "target_pickup_date_id" "uuid", "pickup_date_value" "date", "availability_mode_value" "public"."pickup_availability_mode", "open_value" boolean, "notes_value" "text", "windows_value" "jsonb"); Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: daily_inventory; Type: TABLE; Schema: public; Owner: postgres
--
...
--
-- Name: daily_order_counters; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE IF NOT EXISTS "public"."daily_order_counters" (
    "order_date" "date" NOT NULL,
    "last_value" integer NOT NULL,
    CONSTRAINT "daily_order_counters_last_value_check" CHECK (("last_value" > 0))
);


ALTER TABLE "public"."daily_order_counters" OWNER TO "postgres";
...
--
-- Name: journal_posts; Type: TABLE; Schema: public; Owner: postgres
--
...
--
-- Name: manual_payment_submissions; Type: TABLE; Schema: public; Owner: postgres
--
...
--
-- Name: mutation_rate_limit_buckets; Type: TABLE; Schema: public; Owner: postgres
--
...
CREATE TABLE IF NOT EXISTS "public"."order_item_addons" (
    ...
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "order_item_addons_complimentary_total_check" CHECK ((("is_complimentary" AND ("line_total" = (0)::numeric)) OR ((NOT "is_complimentary") AND ("line_total" = ("unit_price_snapshot" * ("quantity")::numeric))))),
...
--
-- Name: order_item_coatings; Type: TABLE; Schema: public; Owner: postgres
--
...
--
-- Name: pickup_dates; Type: TABLE; Schema: public; Owner: postgres
--
...
--
-- Name: pickup_window_locations; Type: TABLE; Schema: public; Owner: postgres
--
...
--
-- Name: pickup_windows; Type: TABLE; Schema: public; Owner: postgres
--
...
--
-- Name: terms_versions; Type: TABLE; Schema: public; Owner: postgres
--
...
--
-- Name: coatings coatings_slug_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: daily_inventory daily_inventory_pickup_date_product_id_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: daily_inventory daily_inventory_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: daily_order_counters daily_order_counters_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY "public"."daily_order_counters"
    ADD CONSTRAINT "daily_order_counters_pkey" PRIMARY KEY ("order_date");
...
--
-- Name: journal_posts journal_posts_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: journal_posts journal_posts_slug_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: loyalty_accounts loyalty_accounts_user_id_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: loyalty_rewards loyalty_rewards_user_id_reward_type_source_order_id_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: manual_payment_submissions manual_payment_submissions_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: manual_payment_submissions manual_payment_submissions_receipt_path_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: mutation_rate_limit_buckets mutation_rate_limit_buckets_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: notification_deliveries notification_deliveries_idempotency_key_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: notification_deliveries notification_deliveries_provider_message_id_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: notification_webhook_events notification_webhook_events_provider_event_id_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: order_item_addons order_item_addons_order_item_id_addon_id_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: order_item_coatings order_item_coatings_order_item_id_coating_id_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: order_item_coatings order_item_coatings_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: payment_webhook_events payment_webhook_events_provider_event_id_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: pickup_dates pickup_dates_pickup_date_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: pickup_dates pickup_dates_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: pickup_locations pickup_locations_name_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: pickup_window_locations pickup_window_locations_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: pickup_windows pickup_windows_pickup_date_id_start_time_end_time_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: pickup_windows pickup_windows_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: product_variants product_variants_product_id_piece_count_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: terms_versions terms_versions_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: terms_versions terms_versions_version_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: addons_catalog_idx; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: addons_one_default_idx; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: admin_audit_logs_admin_idx; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: coatings_catalog_idx; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: coatings_one_default_idx; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: journal_posts_public_idx; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: loyalty_rewards_redeemed_order_key; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: loyalty_rewards_user_idx; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: manual_approved_reported_reference; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: manual_one_open_review; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: manual_submissions_order_idx; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: mutation_rate_limit_updated_idx; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: notification_deliveries_order_idx; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: notification_deliveries_retry_idx; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: notification_webhook_message_idx; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: order_item_addons_item_idx; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: order_item_coatings_item_idx; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: orders_pickup_date_idx; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: orders_user_checkout_idempotency_key; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: payments_order_key; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: payments_provider_checkout_key; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: payments_provider_payment_key; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: pickup_dates_open_idx; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: pickup_windows_date_idx; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: product_variants_catalog_idx; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: profiles_deletion_due_idx; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: profiles_email_lower_key; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: reviews_public_idx; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: terms_one_current_idx; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: addons addons_set_updated_at; Type: TRIGGER; Schema: public; Owner: postgres
--
...
--
-- Name: orders assign_daily_order_number_before_insert; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE OR REPLACE TRIGGER "assign_daily_order_number_before_insert" BEFORE INSERT ON "public"."orders" FOR EACH ROW EXECUTE FUNCTION "public"."assign_daily_order_number"();


--
-- Name: coatings coatings_set_updated_at; Type: TRIGGER; Schema: public; Owner: postgres
--
...
--
-- Name: daily_inventory daily_inventory_set_updated_at; Type: TRIGGER; Schema: public; Owner: postgres
--
...
--
-- Name: journal_posts journal_posts_set_updated_at; Type: TRIGGER; Schema: public; Owner: postgres
--
...
--
-- Name: loyalty_accounts loyalty_accounts_set_updated_at; Type: TRIGGER; Schema: public; Owner: postgres
--
...
--
-- Name: notification_deliveries notification_deliveries_set_updated_at; Type: TRIGGER; Schema: public; Owner: postgres
--
...
--
-- Name: orders orders_enqueue_transactional_email; Type: TRIGGER; Schema: public; Owner: postgres
--
...
--
-- Name: orders orders_sync_completed_loyalty; Type: TRIGGER; Schema: public; Owner: postgres
--
...
--
-- Name: pickup_dates pickup_dates_set_updated_at; Type: TRIGGER; Schema: public; Owner: postgres
--
...
--
-- Name: pickup_locations pickup_locations_set_updated_at; Type: TRIGGER; Schema: public; Owner: postgres
--
...
--
-- Name: pickup_windows pickup_windows_set_updated_at; Type: TRIGGER; Schema: public; Owner: postgres
--
...
--
-- Name: profiles profiles_enforce_admin_limit; Type: TRIGGER; Schema: public; Owner: postgres
--
...
--
-- Name: daily_inventory daily_inventory_pickup_date_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: daily_inventory daily_inventory_product_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: inventory_adjustments inventory_adjustments_daily_inventory_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: journal_posts journal_posts_author_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: loyalty_rewards loyalty_rewards_redeemed_order_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: loyalty_rewards loyalty_rewards_source_order_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: loyalty_rewards loyalty_rewards_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: manual_payment_submissions manual_payment_submissions_order_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: manual_payment_submissions manual_payment_submissions_reviewed_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: notification_deliveries notification_deliveries_order_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: order_item_coatings order_item_coatings_coating_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: order_item_coatings order_item_coatings_order_item_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: orders orders_pickup_window_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: pickup_window_locations pickup_window_locations_pickup_location_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: pickup_window_locations pickup_window_locations_pickup_window_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: pickup_windows pickup_windows_pickup_date_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: addons; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE "public"."addons" ENABLE ROW LEVEL SECURITY;

--
-- Name: addons addons_read_active_or_admin; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: admin_audit_logs admin_audit_logs_admin_read; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: business_settings business_settings_admin_read; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: coatings; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE "public"."coatings" ENABLE ROW LEVEL SECURITY;

--
-- Name: coatings coatings_read_active_or_admin; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: daily_inventory; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE "public"."daily_inventory" ENABLE ROW LEVEL SECURITY;

--
-- Name: daily_inventory daily_inventory_admin_read; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: daily_order_counters; Type: ROW SECURITY; Schema: public; Owner: postgres
--
...
--
-- Name: inventory_adjustments inventory_adjustments_admin_read; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: journal_posts; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE "public"."journal_posts" ENABLE ROW LEVEL SECURITY;

--
-- Name: journal_posts journal_posts_read_published_or_admin; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: loyalty_accounts loyalty_accounts_read_own_or_admin; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: loyalty_rewards loyalty_rewards_read_own_or_admin; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: manual_payment_submissions; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE "public"."manual_payment_submissions" ENABLE ROW LEVEL SECURITY;

--
-- Name: manual_payment_submissions manual_submission_read; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: mutation_rate_limit_buckets; Type: ROW SECURITY; Schema: public; Owner: postgres
--
...
--
-- Name: notification_deliveries notification_deliveries_admin_read; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: notification_webhook_events; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE "public"."notification_webhook_events" ENABLE ROW LEVEL SECURITY;

--
-- Name: notification_webhook_events notification_webhook_events_admin_read; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: order_item_addons; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE "public"."order_item_addons" ENABLE ROW LEVEL SECURITY;

--
-- Name: order_item_addons order_item_addons_read_own_or_admin; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: order_item_coatings; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE "public"."order_item_coatings" ENABLE ROW LEVEL SECURITY;

--
-- Name: order_item_coatings order_item_coatings_read_own_or_admin; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: order_items order_items_read_own_or_admin; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: orders orders_read_own_or_admin; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: payment_webhook_events payment_webhook_events_admin_read; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: payments payments_read_own_or_admin; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: pickup_dates; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE "public"."pickup_dates" ENABLE ROW LEVEL SECURITY;

--
-- Name: pickup_dates pickup_dates_read_open_or_admin; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: pickup_locations; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE "public"."pickup_locations" ENABLE ROW LEVEL SECURITY;

--
-- Name: pickup_locations pickup_locations_read_active_or_admin; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: pickup_window_locations; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE "public"."pickup_window_locations" ENABLE ROW LEVEL SECURITY;

--
-- Name: pickup_window_locations pickup_window_locations_read_open_or_admin; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: pickup_windows; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE "public"."pickup_windows" ENABLE ROW LEVEL SECURITY;

--
-- Name: pickup_windows pickup_windows_read_open_or_admin; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: product_variants product_variants_read_active_or_admin; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: products products_read_active_or_admin; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: profiles profiles_read_own_or_admin; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: reviews reviews_read_visible_owner_or_admin; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: terms_versions; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE "public"."terms_versions" ENABLE ROW LEVEL SECURITY;

--
-- Name: terms_versions terms_versions_read_current_or_admin; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION "assign_daily_order_number"(); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION "attach_paymongo_checkout"("target_payment_id" "uuid", "checkout_id" "text", "checkout_url" "text"); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION "cancel_account_deletion"(); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION "cancel_unpaid_order"("target_order_id" "uuid", "target_user_id" "uuid", "expired_checkout_id" "text"); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION "consume_mutation_rate_limit"("bucket_key_hashes" "text"[], "maximum_requests" integer, "window_seconds" integer); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION "count_admin_customers"("target_admin_id" "uuid", "search_value" "text"); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION "create_checkout_order"("target_user_id" "uuid", "checkout_key" "uuid", "selected_pickup_window_id" "uuid", "selected_pickup_location_id" "uuid", "customer_name_value" "text", "customer_notes_value" "text", "priced_lines" "jsonb", "subtotal_value" numeric, "discount_value" numeric, "total_value" numeric, "terms_version_value" "text", "loyalty_reward_id" "uuid", "payment_method_value" "text", "qr_payload_value" "text"); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION "deactivate_due_account"("target_user_id" "uuid"); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION "enforce_admin_limit"(); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION "enqueue_transactional_order_email"(); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION "expire_paymongo_order"("target_payment_id" "uuid", "checkout_id" "text"); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION "expire_pending_orders"(); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION "get_admin_customer_summaries"("target_admin_id" "uuid", "search_value" "text", "result_limit" integer, "result_offset" integer); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION "get_admin_dashboard_decisions"("target_admin_id" "uuid", "period_start" timestamp with time zone, "period_end" timestamp with time zone, "previous_start" timestamp with time zone, "previous_end" timestamp with time zone); Type: ACL; Schema: public; Owner: postgres
--

REVOKE ALL ON FUNCTION "public"."get_admin_dashboard_decisions"("target_admin_id" "uuid", "period_start" timestamp with time zone, "period_end" timestamp with time zone, "previous_start" timestamp with time zone, "previous_end" timestamp with time zone) FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."get_admin_dashboard_decisions"("target_admin_id" "uuid", "period_start" timestamp with time zone, "period_end" timestamp with time zone, "previous_start" timestamp with time zone, "previous_end" timestamp with time zone) TO "service_role";


--
-- Name: FUNCTION "get_admin_dashboard_summary"("target_admin_id" "uuid", "period_start" timestamp with time zone, "period_end" timestamp with time zone, "previous_start" timestamp with time zone, "previous_end" timestamp with time zone); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION "get_public_pickup_inventory"(); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION "get_public_pickup_settings"(); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION "is_active_user"(); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION "list_due_paymongo_checkouts"("batch_limit" integer); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION "moderate_order_review"("target_admin_id" "uuid", "target_review_id" "uuid", "visible_value" boolean, "featured_value" boolean); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION "prepare_order_cancellation"("target_order_id" "uuid", "target_user_id" "uuid"); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION "prepare_paymongo_checkout"("target_order_id" "uuid", "target_user_id" "uuid"); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION "process_paymongo_paid_event"("event_key" "text", "target_order_id" "uuid", "target_order_number" "text", "checkout_id" "text", "payment_id" "text", "paid_amount" numeric, "event_summary" "jsonb"); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION "process_resend_delivery_event"("provider_event_id_value" "text", "provider_message_id_value" "text", "event_type_value" "text", "event_created_at_value" timestamp with time zone); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION "promote_admin_by_email"("target_email" "text"); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION "prune_mutation_rate_limit_buckets"(); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION "record_inventory_consumption"("target_admin_id" "uuid", "target_inventory_id" "uuid", "quantity_value" integer, "reason_value" "text", "notes_value" "text"); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION "replace_paymongo_checkout"("target_payment_id" "uuid", "expected_checkout_id" "text", "checkout_id" "text", "checkout_url" "text"); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION "request_account_deletion"(); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION "review_manual_payment"("target_admin_id" "uuid", "target_submission_id" "uuid", "approve" boolean, "reason_value" "text"); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION "set_pickup_date_open"("target_admin_id" "uuid", "target_pickup_date_id" "uuid", "open_value" boolean); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION "submit_manual_payment"("target_user_id" "uuid", "target_order_id" "uuid", "submission_id" "uuid", "receipt_path_value" "text", "reported_reference_value" "text", "reported_amount_value" numeric, "reported_paid_at_value" timestamp with time zone, "reported_recipient_value" "text"); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION "sync_completed_order_loyalty"(); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION "transition_order_status"("target_admin_id" "uuid", "target_order_id" "uuid", "expected_status" "public"."order_status", "next_status" "public"."order_status"); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION "update_catalog_product"("target_admin_id" "uuid", "target_product_id" "uuid", "description_value" "text", "price_per_piece_value" numeric, "active_value" boolean); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION "update_pickup_settings"("target_admin_id" "uuid", "minimum_lead_days_value" integer, "daily_cutoff_time_value" time without time zone, "grace_minutes_value" integer, "operating_start_value" time without time zone, "operating_end_value" time without time zone); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION "upsert_catalog_addon"("target_admin_id" "uuid", "target_addon_id" "uuid", "name_value" "text", "price_value" numeric, "active_value" boolean, "default_value" boolean); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION "upsert_catalog_coating"("target_admin_id" "uuid", "target_coating_id" "uuid", "name_value" "text", "description_value" "text", "image_url_value" "text", "price_per_piece_value" numeric, "active_value" boolean, "default_value" boolean); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION "upsert_daily_inventory"("target_admin_id" "uuid", "target_pickup_date" "date", "target_product_id" "uuid", "stock_total_value" integer, "notes_value" "text"); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION "upsert_journal_post"("target_admin_id" "uuid", "target_post_id" "uuid", "title_value" "text", "excerpt_value" "text", "content_value" "text", "content_type_value" "text", "display_date_value" "date", "cover_image_url_value" "text", "video_url_value" "text", "status_value" "public"."journal_status"); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION "upsert_pickup_location"("target_admin_id" "uuid", "target_location_id" "uuid", "name_value" "text", "description_value" "text", "active_value" boolean); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION "upsert_pickup_schedule"("target_admin_id" "uuid", "target_pickup_date_id" "uuid", "pickup_date_value" "date", "availability_mode_value" "public"."pickup_availability_mode", "open_value" boolean, "notes_value" "text", "windows_value" "jsonb"); Type: ACL; Schema: public; Owner: postgres
--
...
GRANT SELECT,REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."addons" TO "authenticated";
...
GRANT SELECT,REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."business_settings" TO "authenticated";
GRANT SELECT,REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."business_settings" TO "service_role";


--
-- Name: TABLE "coatings"; Type: ACL; Schema: public; Owner: postgres
--

GRANT SELECT,REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."coatings" TO "anon";
GRANT SELECT,REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."coatings" TO "authenticated";
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."coatings" TO "service_role";


--
-- Name: TABLE "daily_inventory"; Type: ACL; Schema: public; Owner: postgres
--

GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."daily_inventory" TO "anon";
GRANT SELECT,REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."daily_inventory" TO "authenticated";
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."daily_inventory" TO "service_role";


--
-- Name: TABLE "daily_order_counters"; Type: ACL; Schema: public; Owner: postgres
--
...
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."inventory_adjustments" TO "anon";
GRANT SELECT,REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."inventory_adjustments" TO "authenticated";
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."inventory_adjustments" TO "service_role";


--
-- Name: TABLE "journal_posts"; Type: ACL; Schema: public; Owner: postgres
--

GRANT SELECT,REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."journal_posts" TO "anon";
GRANT SELECT,REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."journal_posts" TO "authenticated";
...
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."loyalty_rewards" TO "anon";
...
--
-- Name: TABLE "manual_payment_submissions"; Type: ACL; Schema: public; Owner: postgres
--

GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."manual_payment_submissions" TO "anon";
GRANT SELECT,REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."manual_payment_submissions" TO "authenticated";
GRANT ALL ON TABLE "public"."manual_payment_submissions" TO "service_role";


--
-- Name: TABLE "mutation_rate_limit_buckets"; Type: ACL; Schema: public; Owner: postgres
--

GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."mutation_rate_limit_buckets" TO "anon";
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."mutation_rate_limit_buckets" TO "authenticated";
...
GRANT SELECT,REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."notification_deliveries" TO "authenticated";
GRANT SELECT,REFERENCES,TRIGGER,TRUNCATE,MAINTAIN,UPDATE ON TABLE "public"."notification_deliveries" TO "service_role";


--
-- Name: TABLE "notification_webhook_events"; Type: ACL; Schema: public; Owner: postgres
--

GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."notification_webhook_events" TO "anon";
GRANT SELECT,REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."notification_webhook_events" TO "authenticated";
...
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."order_item_addons" TO "anon";
GRANT SELECT,REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."order_item_addons" TO "authenticated";
GRANT SELECT,REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."order_item_addons" TO "service_role";


--
-- Name: TABLE "order_item_coatings"; Type: ACL; Schema: public; Owner: postgres
--

GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."order_item_coatings" TO "anon";
GRANT SELECT,REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."order_item_coatings" TO "authenticated";
...
--
-- Name: SEQUENCE "order_number_sequence"; Type: ACL; Schema: public; Owner: postgres
--
...
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."payment_webhook_events" TO "anon";
GRANT SELECT,REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."payment_webhook_events" TO "authenticated";
...
--
-- Name: TABLE "pickup_dates"; Type: ACL; Schema: public; Owner: postgres
--

GRANT SELECT,REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."pickup_dates" TO "anon";
GRANT SELECT,REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."pickup_dates" TO "authenticated";
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."pickup_dates" TO "service_role";


--
-- Name: TABLE "pickup_locations"; Type: ACL; Schema: public; Owner: postgres
--

GRANT SELECT,REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."pickup_locations" TO "anon";
GRANT SELECT,REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."pickup_locations" TO "authenticated";
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."pickup_locations" TO "service_role";


--
-- Name: TABLE "pickup_window_locations"; Type: ACL; Schema: public; Owner: postgres
--

GRANT SELECT,REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."pickup_window_locations" TO "anon";
GRANT SELECT,REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."pickup_window_locations" TO "authenticated";
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."pickup_window_locations" TO "service_role";


--
-- Name: TABLE "pickup_windows"; Type: ACL; Schema: public; Owner: postgres
--

GRANT SELECT,REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."pickup_windows" TO "anon";
GRANT SELECT,REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."pickup_windows" TO "authenticated";
...
--
-- Name: COLUMN "reviews"."id"; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: COLUMN "reviews"."display_name_snapshot"; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: COLUMN "reviews"."rating"; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: COLUMN "reviews"."comment"; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: COLUMN "reviews"."is_featured"; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: COLUMN "reviews"."created_at"; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE "terms_versions"; Type: ACL; Schema: public; Owner: postgres
--

GRANT SELECT,REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."terms_versions" TO "anon";
GRANT SELECT,REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."terms_versions" TO "authenticated";
...
-- Dumped public schema does not include the Auth-owned trigger or Storage bucket metadata.
...
-- \unrestrict Pa7tBGdgkBWFHOehVoymg8EeXFCh97XDFzo8fsv1HKLPCyYEJQHnKUHhmkRw0nQ
