-- Required launch reference data. This migration is safe to apply to an empty
-- Production project and deliberately avoids users, orders, inventory,
-- payments, pickup dates, reviews, and development-only records.
