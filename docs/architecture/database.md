...
| `submit_order_review`, `moderate_order_review`, `upsert_journal_post`                                               | Reviews/Journal server modules         | `20260911010000_pre_v1_baseline.sql`           | Completed-order ownership/uniqueness, controlled publication and Admin audit                                  |
...
| `get_admin_dashboard_summary`, `get_admin_dashboard_decisions`                                                      | `server-dashboard.ts`                  | `20260922010000_admin_dashboard_decisions.sql` | Authorized period KPIs, product/payment mix, reviews, fulfillment and operational counts                      |
| `assign_daily_order_number`                                                                                         | `orders` insert trigger                | `20260922010000_admin_dashboard_decisions.sql` | Atomic `TLDDMMYY001` allocation for new checkout-created orders; historical identifiers remain valid          |
