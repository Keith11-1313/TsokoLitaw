...
| `get_admin_dashboard_summary`                                                                                       | `server-dashboard.ts`                  | `20260921010000_admin_dashboard_kpis.sql` | Authorized full-period KPI aggregates and current operational counts                                          |
