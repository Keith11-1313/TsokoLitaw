...
| `get_admin_dashboard_summary`, `get_admin_dashboard_decisions`                                                      | `server-dashboard.ts`                  | `20260911010000_pre_v1_baseline.sql`           | Authorized period KPIs, product/payment mix, reviews, fulfillment and operational counts                      |
