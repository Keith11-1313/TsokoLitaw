...
| Blank navigation/loading                     | Deployed commit, `app/loading.tsx`, Boneyard registry/fixture, CSS and actual browser timing  | Add an artificial delay or claim a loading fix without observing it    |

## Loading skeleton

Boneyard remains installed and registered. The earlier whole-skeleton 500 ms hidden delay was
removed; fallback content should render when Next.js activates the loading boundary.
