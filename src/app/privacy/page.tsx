...
const sections: readonly LegalSection[] = [
  ...
  { heading: "Your choices", paragraphs: ["Customers may request correction or deletion of eligible personal information by contacting hello@tsokolitaw.ph. Final procedures will be published before launch."] },
];
