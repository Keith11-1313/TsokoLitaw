  ...
  return (
    ...
    >
          ...
          return (
            <article key={post.title} className="rounded-card border border-border bg-surface p-6">
              ...
              <div className="mt-5 flex items-start justify-between gap-4">
                ...
                <span className="rounded-lg bg-success-background px-2.5 py-1 text-xs font-bold text-success-foreground">{post.status}</span>
              </div>
      ...
      <section className="mt-6 rounded-card border border-border bg-surface p-6">
        ...
        <p className="mt-2 text-sm text-muted-foreground">Choose verified completed-order reviews to feature in the public Journal. Selection persistence will be connected later.</p>
