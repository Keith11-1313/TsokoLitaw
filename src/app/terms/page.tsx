...
const sections: readonly LegalSection[] = [
  ...
  { heading: "Allergens", paragraphs: ["Products may contain or come into contact with milk, cocoa or chocolate ingredients, sesame, peanuts or other nuts, coconut, and cookie ingredients. Final allergen wording remains subject to confirmation against the production recipe before launch."] },
];
