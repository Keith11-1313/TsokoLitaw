export const PICKUP_DATES = [
  {
    ...
    adminLabel: "Saturday, Sep 5, 2026",
  },
  { value: "2026-09-07", label: "Monday, September 7, 2026", adminLabel: "Monday, Sep 7, 2026" },
] as const;

export const PICKUP_OPERATING_DAYS = "Monday to Saturday";
export const PICKUP_OPERATING_HOURS = "7:00 AM to 7:00 PM";
...
export const PICKUP_LOCATIONS = [
  ...
  {
    value: "congress-covered-court",
    label: "UCC Congress, Covered Court",
    shortLabel: "Covered Court",
  },
] as const;
